...
# Ubuntu run symlink for bat and fd 
...
Plugins are cloned into `$ZDOTDIR/plugins/`.
...
Included in the repo at [`starship/starship.toml`](./starship.toml) and loaded automatically via `STARSHIP_CONFIG` in `.zshenv`. Requires a [Nerd Font](https://www.nerdfonts.com) in your terminal.
